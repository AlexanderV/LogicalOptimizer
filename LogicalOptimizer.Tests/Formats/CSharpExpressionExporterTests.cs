...
public class CSharpExpressionExporterTests
{
    ...
    {
        // Arrange
        var constantOne = new ConstantNode(true);
    ...
    {
        // Arrange
        var constantZero = new ConstantNode(false);
    ...
    {
        // Arrange - single-variable expression with a custom method name
        // (also covers single-variable method generation)
    ...
    public void GenerateMethod_Constants_ShouldHandleCorrectly()
    {
        ...
        var constantTrue = new ConstantNode(true);
        var variable = new VariableNode("a");
