...
- ✅ **And-Inverter Graph**: ABC-style AIG with structural hashing, complemented edges and balanced n-ary folding — used internally for honest multi-level size metrics and as a foundation for cut-based rewriting
